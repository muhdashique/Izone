...
urlpatterns = [
    ...
    path('product_gallery/', views.product_gallery, name='product_gallery'), path('product/<int:product_id>/delete/', views.delete_product, name='delete_product'),
    ...
    path('product_add_edit/',views.product_add_edit,name='product_add_edit'),
